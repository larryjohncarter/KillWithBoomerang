...
#pragma warning restore 0649
		...
		private void Awake()
		{
			audioSources = new SimplePool<AudioSource>( 3, () =>
			{
		...
		public AudioSource Play2DClip( AudioClip clip, bool isLooping )
		{
			if( !clip )
				return null;
		...
		public AudioSource Play3DClip( AudioClip clip, Vector3 position, bool isLooping )
		{
			if( !clip )
				return null;
