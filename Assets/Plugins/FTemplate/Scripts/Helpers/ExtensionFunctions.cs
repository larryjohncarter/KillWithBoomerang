...
public static class ExtensionFunctions
{
	...
	public static TweenerCore<float, float, FloatOptions> DOBlendableAlpha( this Graphic graphic, float alpha, float duration )
	{
	...
	public static TweenerCore<Color, Color, ColorOptions> DOColor( this Graphic graphic, Color color, float duration )
	{
		return DOTween.To( () => graphic.color, x => graphic.color = x, color, duration ).SetTarget( graphic );
	}
	...
	{
		button.DOKill( true );
		button.image.DOColor( Color.red, 0.12f ).SetLoops( 2, LoopType.Yoyo ).SetTarget( button );
