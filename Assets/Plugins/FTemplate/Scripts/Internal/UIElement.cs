...
namespace FTemplateNamespace
{
	...
	internal class UIElement
	{
		...
		internal static readonly UIElementType[] UI_HUD_ELEMENTS = new UIElementType[]
		{
			...
			UIElementType.FeverSlider,
			UIElementType.FeverFeedback,
			UIElementType.LevelPassedText,
			UIElementType.BonusLevelText,
		...
		internal static readonly UIElementType[] UI_LOADING_BARS = new UIElementType[]
		{
			UIElementType.LoadingBar1,
			UIElementType.LoadingBar2,
			UIElementType.LoadingBar3
		};
